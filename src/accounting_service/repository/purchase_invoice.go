...
func (repo *PurchaseInvoiceRepository[T]) CreatePurchase(tx *gorm.DB, parent *structs.PurchaseInvoice) error {
	return tx.Create(parent).Error
}

// CreateDetail inserts the detail record into the database
func (repo *PurchaseInvoiceRepository[T]) CreateDetail(tx *gorm.DB, detail *structs.PurchaseInvoiceItem) error {
	return tx.Create(detail).Error
}

// func (repo *PurchaseInvoiceRepository[T]) UpdatePurchase(tx *gorm.DB, purchase *structs.SalesInvoice) error {
