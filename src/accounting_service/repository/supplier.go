...
func (repo *GeneralRepository[T]) PaginateDataSupp(start int, length int, search string, orderBy string, orderDir string, status string) (structs.PaginatedResponse[T], error) {
	var data []T
